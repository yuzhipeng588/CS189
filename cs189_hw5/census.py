...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 13 23:36:46 2016
...
rawdata,rawdata_t=load_data()
corpus,rev_corpus=little_corpus(pd.concat([rawdata,rawdata_t]))
x_train,x_test=vectorized(rawdata,rawdata_t)
# one hot based on corpus

#x_train = data_onehot(rawdata.drop('label', 1),corpus)
#x_test = data_onehot(rawdata_t,corpus)

y_train=rawdata['label'].tolist()
